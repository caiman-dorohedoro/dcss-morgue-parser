  ...
  it('builds equipment catalog entries from Crawl source snippets', () => {
    const catalog = buildCrawlEquipmentCatalogFromSource({
      ...
      itemProp: [
        ...
        '{',
        '    { ARM_ROBE, "robe", 2, 0, 9, SLOT_BODY_ARMOUR, SIZE_LITTLE, SIZE_LARGE, true },',
        '    DRAGON_ARMOUR(ACID, "acid", 6, -50, 400, ARMF_RES_CORR),',
        '};',
      ].join('\n'),
      itemName: [
    ...
    expect(catalog.unrandarts).toEqual([
      ...
      },
      {
        ...
        displayType: null,
        flags: ['nogen', 'no_upgrade'],
        propertyGeneration: 'randomized',
        isDeleted: false,
        isNoGen: true,
      },
    ])
